  ...
  return (
    <>
      ...
      <div className="filters">
        ...
        <span style={{ marginLeft: 'auto' }}>총 평가: <strong>{formatMoney(grandTotal)}</strong></span>
      </div>
              ...
              {group.accounts.map((account) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => navigate(`/investment/accounts/${account.id}`)}
                  >
                    ...
                    <div className="account-row-value">
                      ...
                      {supportsHoldings && perf && (
                        <div className={Number(perf.profit_loss_rate) >= 0 ? 'text-success' : 'text-danger'} style={{ fontSize: 13 }}>
