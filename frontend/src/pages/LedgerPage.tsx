...
import { formatMoney, formatShortDate, monthDateRange, todayISO } from '../utils/format';

import { aggregateDailyTotals } from '../utils/ledger';
      ...
      <PageHeader
        ...
        actions={
          ...
          <>
            ...
            <Link to={`/ledger/analysis${monthQuery}`} className="btn btn-secondary">분석</Link>

            <Link to={`/ledger/budget${monthQuery}`} className="btn btn-secondary">예산</Link>
            ...
            dailyTotals[selectedDate]?.transactions.length ? (
              ...
              <div className="card" style={{ marginTop: 16 }}>
                ...
                <h3 className="section-title" style={{ marginTop: 0 }}>
                  ...
                  {formatShortDate(selectedDate)} 거래
              ...
              <div className="card ledger-calendar-empty-day" style={{ marginTop: 16 }}>
