    ...
    <>
      ...
      <div className="settings-layout">
        <nav className="settings-nav">
          <NavLink to="/settings" end className={({ isActive }) => isActive ? 'active' : ''}>카테고리</NavLink>
          <NavLink to="/settings/recurring" className={({ isActive }) => isActive ? 'active' : ''}>정기 항목</NavLink>
          <NavLink to="/settings/cards" className={({ isActive }) => isActive ? 'active' : ''}>내 카드</NavLink>
          <NavLink to="/settings/liabilities" className={({ isActive }) => isActive ? 'active' : ''}>부채</NavLink>
          <NavLink to="/settings/market" className={({ isActive }) => isActive ? 'active' : ''}>증권 API</NavLink>
          <NavLink to="/settings/backup" className={({ isActive }) => isActive ? 'active' : ''}>백업</NavLink>
        </nav>
        <div className="settings-content">
          <Routes>
            ...
            <Route path="liabilities" element={<LiabilitiesPanel />} />
